  ...
  lazy val root = Project(
    ...
    settings = Defaults.coreDefaultSettings ++ publishSettings ++ Seq(
      ...
      libraryDependencies ++= Seq(
        ...
        ("org.scalatest" %% "scalatest" % Versions.scalatest).exclude("org.scala-lang.modules","scala-xml_2.12") % Test,
        ("ch.qos.logback" % "logback-classic" % Versions.logback).exclude("org.slf4j","slf4j-api") % Test,
