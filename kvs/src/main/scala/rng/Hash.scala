...
final case class Put(k: Array[Byte], v: Array[Byte])
final case class Get(k: Array[Byte])
final case class Delete(k: Array[Byte])

final case object RestoreState

final case class InternalPut(k: Array[Byte], v: Array[Byte])
